 ...
 * org.apache.tomcat.util.http.fileupload.FileItemFactory; import
 * org.apache.tomcat.util.http.fileupload.disk.DiskFileItemFactory; import
 ...
 * 
 * import domain.ImageDTO; import enums.Props; import lombok.Data; public class
 * ImageProxy implements Proxy{ ImageDTO img;
 * 
 ...
 * = new ServletFileUpload(factory); upload.setFileSizeMax(1024 * 1024 * 40);
 * upload.setFileSizeMax(1024 * 1024 * 50); List<FileItem> items = null;
 * 
 * 
 * try { File file = null; items = upload.parseRequest(new
 ...
 * System.out.println("이미지주인공"+request.getParameter("customerID")); } } } catch
